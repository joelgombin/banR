...
The `banR` package is a light R client for the [BAN API](https://adresse.data.gouv.fr/outils/api-doc/adresse). 
The [Base Adresse Nationale (BAN)](https://adresse.data.gouv.fr/) is an open database of French adresses, produced by OpenStreetMap, La Poste, the IGN and Etalab.
