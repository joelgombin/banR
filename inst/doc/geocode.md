...
```
    ...
    ## Writing tempfile to.../tmp/RtmprZnWJL/file2951633bd6e3.csv
    ...
    ## $ z                  <dbl> -0.7916957, -0.7563508, -0.3894949
...
```
    ...
    ## Writing tempfile to.../tmp/RtmprZnWJL/file2951620c79e4.csv
...
```
    ...
    ## Writing tempfile to.../tmp/RtmprZnWJL/file29512597aa00.csv
...
```
    ...
    ## Writing tempfile to.../tmp/RtmprZnWJL/file29514a0a2559.csv
    ...
    ## Observations: 10
    ## Variables: 16
    ## $ nom                <chr> "w", "u", "m", "q", "h", "t", "f", "s", "o"...
    ## $ longitude          <dbl> 2.297121, 2.207908, 2.433294, 2.442644, 2.3...
    ## $ latitude           <dbl> 48.84533, 48.87362, 48.87276, 48.87979, 48....
    ## $ result_latitude    <dbl> 48.84534, 48.87329, 48.87274, 48.87985, 48....
    ## $ result_longitude   <dbl> 2.297203, 2.207137, 2.433189, 2.442718, 2.3...
    ## $ result_label       <chr> "148 Rue du Théâtre 75015 Paris", "51 B Rue...
    ## $ result_distance    <int> 6, 67, 7, 8, 4, 4, 89, 10, 204, 16
    ## $ result_type        <chr> "housenumber", "housenumber", "housenumber"...
    ## $ result_id          <chr> "75115_9230_9ea8f1", "92063_3600_1ead14", "...
    ## $ result_housenumber <chr> "148", "51 B", "48", "6", "66", "118", "1",...
    ## $ result_name        <chr> "Rue du Théâtre", "Rue des Talus", "Rue des...
    ## $ result_street      <chr> NA, NA, NA, NA, NA, NA, NA, NA, NA, NA
    ## $ result_postcode    <chr> "75015", "92500", "93100", "93230", "75019"...
    ## $ result_city        <chr> "Paris", "Rueil-Malmaison", "Montreuil", "R...
    ## $ result_context     <chr> "75, Paris, Île-de-France", "92, Hauts-de-S...
    ## $ result_citycode    <chr> "75115", "92063", "93048", "93063", "75119"...
